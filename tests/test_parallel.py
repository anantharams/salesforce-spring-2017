...
if not tests.USE_ANSWERS:
    from excercises.parallel import square_numbers
else:
    from answers.parallel import square_numbers


class ParallelExcercises(unittest.TestCase):
    def test_square_numbers(self):
        squares_100 = set([0, 1, 4, 9, 16, 25, 36, 49, 64, 81, 100, 121, 144, 169, 196, 225, 
            ...
            9409, 9604, 9801])
        self.assertEqual(set(square_numbers(range(100), 8)), squares_100)