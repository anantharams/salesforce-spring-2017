def add_and_divide(a, b):
    ...
    Test with:
    $ py.test tests/test_exceptions.py::ExceptionExcercises::test_add_and_divide
    """
    return None


class ArgIsNoneException(Exception):
    pass
...
def throw_my_exception(*args):
    ...
    Test with:
    $ py.test tests/test_exceptions.py::ExceptionExcercises::test_throw_my_exception
    """
    return None
